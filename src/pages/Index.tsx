...
const Index = () => {
  ...
  return (
    <div className="flex flex-col bg-background select-none h-screen" style={{ userSelect: 'none', WebkitUserSelect: 'none', height: 'calc(100vh - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px))' }}>
      <SignalInput
